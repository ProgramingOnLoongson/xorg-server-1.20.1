...
static const int ls7a1000_chip_ids[] = {
#define CHIPSET(chip, family, name) chip,
...
static const struct {
   ...
   { 0x0014, "loongson-drm", ls7a1000_chip_ids, ARRAY_SIZE(ls7a1000_chip_ids) },
   { 0x0014, "etnaviv", ls7a1000_chip_ids, ARRAY_SIZE(ls7a1000_chip_ids) },
